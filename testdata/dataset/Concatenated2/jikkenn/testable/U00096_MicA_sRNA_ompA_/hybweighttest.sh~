...
do
	...
	do
	    ...
	    echo "ib-t == ${i}"
	    echo "ob-t == ${j}"
	    ${RACTIPHOM}/src/ractip_hom -t ${i} -u ${j} --hyb-mix-w=${k} OxyS.fa U00096_OxyS_sRNA_fhlA_1.fa fhlA.fa U00096_OxyS_sRNA_fhlA_2.fa > tritest_hyb_t_u/ibt-${i}-obt-${j}-hyb-${k}.fa &
