...
const char *gengetopt_args_info_purpose = "RactIP_Hom";
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->engine_seq_arg));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->mccaskill_given)
    write_into_file(outfile, "mccaskill", 0, 0 );
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'a':	/*  weight for hybridization.  */
          ...
          break;
        case 'b':	/* weight for unpaired bases.  */
        ...
        case 't':	/* Threshold for base-pairing probabilities.  */
          ...
          if (update_arg( (void *)&(args_info->fold_th_arg), 
              ...
              &(local_args_info.fold_th_given), optarg, 0, "0.1", ARG_FLOAT,
              check_ambiguity, override, 0, 0,
              "fold-th", 't',
              additional_error))
            goto failure;
        ...
        case 's':	/* Threshold for accessible probabilities.  */
          ...
          if (update_arg( (void *)&(args_info->acc_th_arg), 
              ...
              &(local_args_info.acc_th_given), optarg, 0, "0.0", ARG_FLOAT,
              check_ambiguity, override, 0, 0,
              "acc-th", 's',
              additional_error))
            goto failure;
          ...
          break;
        case 'm':	/* Use McCaskill model for folding.  */
        
        
          if (update_arg((void *)&(args_info->mccaskill_flag), 0, &(args_info->mccaskill_given),
              &(local_args_info.mccaskill_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "mccaskill", 'm',
              additional_error))
            goto failure;
        
          break;
        case 'i':	/* Allow isolated base-pairs.  */
          ...
          if (update_arg((void *)&(args_info->allow_isolated_flag), 0, &(args_info->allow_isolated_given),
              ...
              check_ambiguity, override, 1, 0, "allow-isolated", 'i',
              additional_error))
            goto failure;
        ...
        case 'P':	/* Read the energy parameter file for Vienna RNA package.  */
          ...
          break;
        case 'p':	/* do not use the constraints for interenal pseudoknots.  */
        ...
        case 'w':	/* mixture weights of inference engines.  */
          ...
          if (update_arg( (void *)&(args_info->mix_weight_arg), 
              ...
              &(local_args_info.mix_weight_given), optarg, 0, "1.0", ARG_FLOAT,
              check_ambiguity, override, 0, 0,
              "mix-weight", 'w',
              additional_error))
            goto failure;
        ...
        case 'A':	/* specify the inference engine for independent Alignment.  */
          ...
          if (update_arg( (void *)&(args_info->engine_aln_arg), 
               &(args_info->engine_aln_orig), &(args_info->engine_aln_given),
              &(local_args_info.engine_aln_given), optarg, 0, "CONTRAlign", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "engine-aln", 'A',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "max-w") == 0)
          {
