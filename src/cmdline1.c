/*
  ...
  gengetopt --file-name=cmdline1 -u
...
const char *gengetopt_args_info_purpose = "RactIP";
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->engine_aln_arg = gengetopt_strdup ("Alifold");
      ...
      switch (c)
        ...
        case 'A':	/* specify the inference engine for independent Alignment.  */
          ...
          if (update_arg( (void *)&(args_info->engine_aln_arg), 
              ...
              &(local_args_info.engine_aln_given), optarg, 0, "Alifold", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "engine-aln", 'A',
              additional_error))
            goto failure;
